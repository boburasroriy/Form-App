                            ...
                            <div class='w-full max-w-lg px-10 py-8 mx-auto bg-dark rounded-lg shadow-xl'>
                                <div class='max-w-md mx-auto space-y-6'>
                                    ...
                                    <form action="">
                                        ...
                                        <input type="text" class="bg-black p-3 mt-2 mb-4 w-full  rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none">
                                        <label class="uppercase  text-sm font-bold opacity-70">Email</label>
                                        <input type="text" class="p-3  mt-2 mb-4 w-full bg-black rounded">
                                        <label class="uppercase text-sm font-bold opacity-70">Language</label>
                                        <input type="file" class="p-3  mt-2 mb-4 w-full bg-black rounded">
